  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Fonctionnalités Kompta" },
      {
        ...
        content: "20+ modules pour une comptabilité OHADA conforme et moderne.",
      },
    ],
  }),
...
const groups = [
  {
    ...
    items: [
      {
        icon: BookOpenCheck,
        t: "Plan comptable SYSCOHADA",
        d: "Classes 1 à 9 pré-paramétrées, personnalisables.",
      },
      {
        icon: Receipt,
        t: "Journaux & écritures",
        d: "Achats, ventes, banque, caisse, OD. Contrôle débit = crédit.",
      },
      {
        icon: FileCheck2,
        t: "Balance & grand livre",
        d: "Export PDF/Excel, filtres par exercice et période.",
      },
  ...
  },
  {
    ...
    items: [
      {
        icon: Users,
        t: "Tiers clients & fournisseurs",
        d: "Comptes auxiliaires, encours, relances.",
      },
      {
        icon: Receipt,
        t: "Facturation ventes",
        d: "Devis, factures, avoirs, numérotation légale.",
      },
      {
        icon: Wallet,
        t: "Achats & dépenses",
        d: "Saisie facture fournisseur, ventilation analytique.",
      },
  ...
  },
  {
    ...
    items: [
      {
        icon: Banknote,
        t: "Banques, caisses, Mobile Money",
        d: "Multi-comptes, rapprochement assisté.",
      },
      {
        icon: Calculator,
        t: "Fiscalité camerounaise",
        d: "TVA, IS, IRPP : règles versionnées, jamais codées en dur.",
      },
      {
        icon: FileSpreadsheet,
        t: "DSF & états financiers",
        d: "Bilan, compte de résultat, TAFIRE, contrôles de cohérence.",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: ShieldCheck,
        t: "Sécurité multi-tenant",
        d: "Isolation stricte par entreprise (RLS Postgres).",
      },
