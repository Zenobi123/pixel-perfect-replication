...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Démarrez gratuitement 14 jours avec Kompta, la comptabilité OHADA simplifiée." },
    ],
  }),
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted px-4 py-12">
      <div className="w-full max-w-md space-y-6 rounded-2xl border bg-card p-8 shadow-xl">
        <div className="text-center">
          <Link to="/" className="text-2xl font-bold tracking-tight">Kompta</Link>
          <h1 className="mt-4 text-xl font-semibold">Créer votre compte</h1>
          <p className="mt-1 text-sm text-muted-foreground">14 jours d'essai gratuit, sans carte bancaire</p>
        </div>
